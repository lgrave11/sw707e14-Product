...
namespace BicycleStation.StationDBService {
    ...
    public partial class StationToDB_Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:StationToDB_Service#soapaction", RequestNamespace="urn:StationToDB_Service", ResponseNamespace="urn:StationToDB_Service", Use=System.Web.Services.Description.SoapBindingUse.Literal)]
        [return: System.Xml.Serialization.XmlElementAttribute("return")]
        public bool BicycleReturnedToDockAtStation(int bicycle_id, int station_id, int dock_id) {
        ...
        /// <remarks/>
        public void BicycleReturnedToDockAtStationAsync(int bicycle_id, int station_id, int dock_id) {
            this.BicycleReturnedToDockAtStationAsync(bicycle_id, station_id, dock_id, null);
        }
        
        /// <remarks/>
        public void BicycleReturnedToDockAtStationAsync(int bicycle_id, int station_id, int dock_id, object userState) {
            ...
            this.InvokeAsync("BicycleReturnedToDockAtStation", new object[] {
                        bicycle_id,
                        station_id,
                        dock_id}, this.BicycleReturnedToDockAtStationOperationCompleted, userState);
        }
