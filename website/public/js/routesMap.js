...
function initialize() {
    ...
    for(var key in coords) 
    {
        ...
        var iwcontent = '<div id="content">' +
                                   '<h2 id="firstHeading" class="firstHeading" style="margin-bottom:-10px; white-space: nowrap; line-height:1.35;overflow:hidden;">Bicycle ' + key + '</h2>' + 
                        '<div id="bodyContent"><p style="white-space: nowrap; line-height:1.35;overflow:hidden;">' + 
                        'Route Length: ' + Math.round(google.maps.geometry.spherical.computeLength(routePath.getPath().getArray())) / 1000 + 'km </p></div></div>';
