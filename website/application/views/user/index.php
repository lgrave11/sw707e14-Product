<div id="sign-in"> 
		...
		<form method="POST" action="/user/login<?php if ($target !== '') echo '/?target='.$target; ?>" id="form-login">
			 <b>User</b><br><input class="padding-field" type="text" name="username" size="50%"><br> 
			 <b>Password</b><br><input class="padding-field" type="password" name="password" size="50%"><br> 
			 <div id="login-fields" >
